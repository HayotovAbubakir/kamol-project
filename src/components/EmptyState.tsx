...
export function EmptyState({ title, description, action }: EmptyStateProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-dashed border-app-accent/25 bg-gradient-to-b from-app-card to-app-bg/50 px-4 py-8 text-center shadow-[0_16px_48px_rgba(29,39,32,0.08)] dark:shadow-[0_16px_48px_rgba(0,0,0,0.35)] dark:ring-1 dark:ring-metallic-green/10 sm:px-6 sm:py-10">
      ...
      <div className="relative">
        ...
        <h3 className="font-display text-lg font-semibold text-app-text sm:text-xl">{title}</h3>
